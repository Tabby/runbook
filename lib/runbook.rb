...
module Runbook
  def self.book(title, *tags, labels: {}, &block)
    ...
    Entities::Book.new(title, tags:, labels:).tap do |book|
  ...
  def self.section(title, *tags, labels: {}, &block)
    Configuration.load_config
    Entities::Section.new(title, tags:, labels:).tap do |section|
  ...
  def self.setup(*tags, labels: {}, &block)
    Configuration.load_config
    Entities::Setup.new(tags:, labels:).tap do |setup|
  ...
  def self.step(title = nil, *tags, labels: {}, &block)
    ...
    Configuration.load_config
    Entities::Step.new(title, tags:, labels:).tap do |step|
